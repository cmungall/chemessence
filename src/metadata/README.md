 ...
 * [chemessence.yml](chemessence.yml)
     * Determines how your purl.obolibrary.org/obo/chemessence/ redirects will be handled
     ...
     * Paste in the contents of [chemessence.yml](chemessence.yml)
 ...
 * [chemessence.md](chemessence.md)
     ...
     * Paste in the contents of [chemessence.md](chemessence.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
